...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="portfolio owl-carousel owl-theme">
      <div class="item">
        <a href="/portfolio/portfolio-01.jpg" class="swipebox" rel="portfolio" ><img src="/portfolio/portfolio-01-th.jpg" alt="Silvia Galasso | Portfolio | grafica editoriale" /></a>
        <div class="description">
          <h5>grafica editoriale: <br class="hidden-sm-up" />
          progetto grafico <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
          impaginazione <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
          correzione bozze
          </h5>
          <p>
      ...
      <div class="item">
        <a href="/portfolio/portfolio-02.jpg" class="swipebox" rel="portfolio" ><img src="/portfolio/portfolio-02-th.jpg" alt="Silvia Galasso | Portfolio | grafica editoriale" /></a>
        <div class="description">
          <h5>grafica editoriale: <br class="hidden-sm-up" />
          progetto grafico <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
          impaginazione <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
      ...
      <div class="item">
        <a href="/portfolio/portfolio-03.jpg" class="swipebox" rel="portfolio" ><img src="/portfolio/portfolio-03-th.jpg"  alt="Silvia Galasso | Portfolio | grafica editoriale" /></a>
        <div class="description">
          <h5>grafica editoriale: <br class="hidden-sm-up" />
          progetto grafico <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
          impaginazione <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
      ...
      <div class="item">
        <a href="/portfolio/portfolio-04.jpg" class="swipebox" rel="portfolio" ><img src="/portfolio/portfolio-04-th.jpg"  alt="Silvia Galasso | Portfolio | grafica editoriale" /></a>
        <div class="description">
          <h5>grafica editoriale: <br class="hidden-sm-up" />
          progetto grafico <br class="hidden-sm-up" /><span class="hidden-xs-down">|</span>
          impaginazione</h5>
